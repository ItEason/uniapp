<template>
  ...
  <!-- 提交按钮 -->
  <button class="button" @tap.prevent="onSubmit">保存并使用</button>
</template>

<script setup lang="ts">
import { ref } from 'vue'
import { addressAddAPI, getMemberAddressByIdAPI, putMemberAddressByIdAPI } from '@/services/address'
...
const onSubmit = async () => {
  ...
  try {
    ...
    if (query.id) {
      ...
      // 新建地址请求
      await addressAddAPI(form.value)
    }
    // 成功提示
