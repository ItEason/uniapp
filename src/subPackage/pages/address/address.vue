<template>
  <view class="viewport">
        ...
        <uni-swipe-action class="address-list">
          ...
          <uni-swipe-action-item class="item" v-for="item in addressList" :key="item.id">
            ...
            <view class="item-content">
              ...
              <navigator open-type="navigate" class="edit" hover-class="none"
                :url="`/subPackage/pages/addressForm/addressForm?id=${item.id}`">
                修改
              </navigator>
            </view>
            <!-- 右侧插槽 -->
    ...
    <!-- 添加按钮 -->
    <view class="add-btn">
      <navigator open-type="navigate" hover-class="none" url="/subPackage/pages/addressForm/addressForm">
        新建地址
      </navigator>
    </view>
  </view>
