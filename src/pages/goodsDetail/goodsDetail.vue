<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper circular :current="currentIndex" @change="changeIndex">
          <swiper-item v-for="item in goodsDetail?.mainPictures" :key="item">
            <image @tap.prevent="previewImg(item)" mode="aspectFill" :src="item" />
          </swiper-item>
        </swiper>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item" v-for="item in goodsDetail?.details.properties">
            <text class="label">{{ item.name }}</text>
            <text class="value">{{ item.value }}</text>
          </view>
        </view>
        <!-- 图片详情 -->
        <image lazy-load="true" mode="widthFix" v-for="item in goodsDetail?.details.pictures" :src="item"></image>
      </view>
    </view>
...
import { getGoodsDetailAPI } from '@/services/goodsDetail'
import { ref } from 'vue';
 ...
 * @param e
 */
const changeIndex = (e: UniHelper.SwiperOnChangeEvent) => {
